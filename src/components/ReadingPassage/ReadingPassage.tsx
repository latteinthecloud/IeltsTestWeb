...
export default function ReadingPassage(){
    return(
        <div className="reading-section-container">
            ...
            <img 
                src="https://iotcdn.oss-ap-southeast-1.aliyuncs.com/2024-03/Why%20Do%20We%20Touch%20Strangers%20So%20Much-%20A%20History%20Of%20The%20Handshake%20Offers%20Clues%402x.png"
                alt="section-image">
            </img>
            <h2>Title</h2>
            <p>
