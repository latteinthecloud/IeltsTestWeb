        ...
        <div className="start-page-container">
            ...
            <div className="content-container">
                ...
                <div className="question-list-container">
                    <h1>Question 1-3</h1>
                    <h2>Choose the correct letter <strong>A, B, C</strong> or <strong>D</strong>.</h2>
                    <MultipleChoiceTest
                        questionOrder={1}
                ...
                <div className="question-list-container">
                    <h1>Question 4-7</h1>
                    <h2>Do the following statements agree with the views of the writer in Reading Passage?</h2>
                    <h2><strong>TRUE</strong>: if the statement agrees with the information</h2>
                    <h2><strong>FALSE</strong>: if the statement contradicts the information</h2>
                    <h2><strong>NOT GIVEN</strong>: If there is no information on this</h2>
                ...
                <div className="question-list-container">
                    <h1>Question 8-10</h1>
                    <h2>Look at the following statements and the list below. Match each statement with the correct answer.</h2>
                    <div className="matching-table-container">
                        <table>
                            <thead>
                                <tr>
                                    <th colSpan={2} style={{textAlign: "center"}}>List of people</th>
                                </tr>   
                            </thead>

                            <tbody>
                                <tr>
                                    <td className="matching-row"><strong>A</strong></td>
                                    <td>Stanley Rapoport</td>
                                </tr>
                                <tr>
                                    <td className="matching-row"><strong>B</strong></td>
                                    <td>Marion Diamond</td>
                                </tr>
                                <tr>
                                    <td className="matching-row"><strong>C</strong></td>
                                    <td>Warner Schaie</td>
                                </tr>
                            </tbody>
                        </table>
